...
2. `docs/external_safety_import_review_sample.md`
3. `docs/context_audit_codebook.md`
4. `data/raw/combined_candidates_binary_preview.jsonl`
5. `data/raw/external_safety_binary_preview.jsonl`
6. `data/eval/risk_test_preview.jsonl`
7. `data/eval/normal_test_preview.jsonl`
...
2. `docs/context_requirement_audit.md` 里的 `D03` 重复文本组。
